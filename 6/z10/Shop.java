...
public class Shop {
    ...
    public static void main(String[] args) {
        ...
        while (end == false) {
            System.out.printf(
                    "%nМеню%n1.Добавить компьютер%n2.Удалить компьютер%n3.Найти компьютер%n0.Закрыть программу%n");
            n = scanner.nextInt();
            switch (n) {
                case 1: {
                    buf = new Computer();
                ...
                case 3: {
                    ...
                    switch (n) {
                        case 1: {
                            System.out
                                    .printf("Меню поиска%n1.Поиск по name%n2.Поиск по MHz%n3.Поиск по Core%n0.Назад%n");
                            n = scanner.nextInt();
                            switch (n) {
                                case 1: {
                        ...
                        case 2: {
                            System.out.printf(
                                    "Меню поиска%n1.Поиск по name%n2.Поиск по MHz%n3.Поиск по Gigabyte%n0.Назад%n");
                            n = scanner.nextInt();
                            switch (n) {
                                case 1: {
                        ...
                        case 3: {
                            System.out.printf(
                                    "Меню поиска%n1.Поиск по name%n2.Поиск по Hz%n3.Поиск по diagonal%n0.Назад%n");
                            n = scanner.nextInt();
                            switch (n) {
                                case 1: {
